		          ...
		          <div class="p-3 p-lg-5 border bg-white">
		            ...
		            <div class="form-group row">
		              <div class="col-md-12">
		                ...
		                <input type="text" class="form-control" id="address" name="Address" placeholder="Tên đường" required="required">
		              </div>
		            </div>
		            ...
		            <div class="form-group">
		              <label for="status" class="text-black">Ghi chú cho nhà hàng</label>
		              <textarea name="status" id="status" cols="30" rows="5" class="form-control" placeholder="Write your notes here..."></textarea>
		            </div>
		              ...
		              <div class="p-3 p-lg-5 border bg-white">
		                <table class="table site-block-order-table mb-5">
		                  ...
		                  <c:forEach var="item" items="${cart.cart_items}">
		                    <tr>
		                      <td> <img style="width: 60px; height: 45px;" src="${item.product.image}" alt="Image" class="img-fluid"> <b>${item.product.nameProduct}</b><strong class="mx-2">x</strong> ${item.quantity}</td>
